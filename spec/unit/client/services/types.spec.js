describe('Types Service Test', function() {

  beforeEach(function() {
    module('docman');
  });

  var Types, httpBackend;
  ...
  describe('Types unit tests', function() {
    it('find should be a function', function() {
      expect(Types.find).toBeDefined();
      expect(typeof Types.find).toBe('function');
    });
    it('should test success of find function', function() {
      ...
      httpBackend.when('POST', '/api/types/find').respond(200, {
        res: 'res'
      });
      Types.find({
        data: 'data'
    ...
    it('should test error of find function', function() {
      ...
      httpBackend.when('POST', '/api/types/find').respond(500, {
        err: 'err'
      });
      Types.find({
        data: 'data'
